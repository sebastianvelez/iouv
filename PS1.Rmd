...
beta <- 2.5 #made up parameter on characteristics
alpha <- 1.8 #made up parameter in price
eta <- 1.9 #made up parameter on characteristic (price eq)
...
uVec1 <- cbind(uVec,uOg)

choices <- apply(uVec1,1,which.max)
